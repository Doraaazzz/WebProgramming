...
<header class="header">
    <div class="inf_block_1">Voronina Darya Sergeevna
        <div class="inf_block_2">
            group: P32311 <br> numder: 3004
        </div>
    </div>
    <div><img src="img/logo.png"  class="logo" alt="y(.)"></div>
</header>
...
<div class="main_content">
    ...
    <div class="data">
        <div class="reset"> <button class="reset_button" type="reset" value="RESET"> Reset </button> </div>
        <form class="form" id="form_for_sending" action="ControllerServlet" method="get" >
            ...
            <p class="blocks_of_data">Input x value : <input type="text" name="coordinate_x" id="x_value" class="x" placeholder="from -5 to 5" maxlength="10"> </p>

            <p class="y_value blocks_of_data"> Choose y value:
                <label> <input type="checkbox" name="coordinate_y" value="-3">-3</label>
                <label> <input type="checkbox" name="coordinate_y" value="-2">-2</label>
                <label> <input type="checkbox" name="coordinate_y" value="-1">-1</label>
                <label> <input type="checkbox" name="coordinate_y" value="0">0</label>
                <label> <input type="checkbox" name="coordinate_y" value="1">1</label>
                <label> <input type="checkbox" name="coordinate_y" value="2">2</label>
                <label> <input type="checkbox" name="coordinate_y" value="3">3</label>
                <label> <input type="checkbox" name="coordinate_y" value="4">4</label>
                <label> <input type="checkbox" name="coordinate_y" value="5">5</label>
            </p>
